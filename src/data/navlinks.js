...
export const navlinks = [
  ...
  { title: "Services", label: "Services", path: "/services" },
  ...
  { title: "Pricing", label: "Pricing", path: "/pricing" },
  {
    title: "Legal", label: "Legal", path: "/legal", children: [
      ...
      { title: "Terms And Conditions", label: "Terms of Service", path: "/legal/terms-of-service", description: "Terms of use for our website and services" },
    ]
  },
];
