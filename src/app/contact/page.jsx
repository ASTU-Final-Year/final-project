    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/20">
      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="text-center mb-12">
          <Badge
            variant="outline"
            className="border-indigo-200 text-indigo-700 bg-indigo-50/50 px-4 py-1.5 mb-4"
          >
            <Headphones className="h-3.5 w-3.5 mr-1" />
            24/7 Support Available
          </Badge>
          <h1 className="text-4xl font-bold text-indigo-950 mb-3">
            Get in Touch
          </h1>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-indigo-600">
                      support@servesyncplus.et
                    </p>
                    <p className="text-sm text-indigo-600">
                      privacy@servesyncplus.et
                    </p>
                    <p className="text-sm text-indigo-600">
                      legal@servesyncplus.et
                    </p>
                  </div>
                </div>
        ...
        {/* FAQ Section */}
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-indigo-950 text-center mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="border-indigo-100">
              ...
              <CardContent>
                <p className="text-indigo-600">
                  Yes! You can reach us at <strong>+251-11-554-3322</strong>{" "}
