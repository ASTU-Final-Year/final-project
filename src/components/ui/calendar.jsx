  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full rounded-md p-0 text-center select-none data-[selected=true]:rounded-md data-[selected=true]:bg-primary/15",
          // "group/day relative aspect-square h-full w-full rounded-md p-0 text-center select-none [&:last-child[data-selected=true]_button]:rounded-r",
        ...
        today: cn(
          "bg-primary/10 border border-primary/25 rounded-md text-primary data-[selected=true]:rounded",
